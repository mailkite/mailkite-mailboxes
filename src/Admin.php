				...
				<tr>
					...
					<td>
						<?php if ( ! Manager::role_allowed( $user ) ) : ?>
							<em><?php esc_html_e( 'This role cannot have a mailbox on this site.', 'mailkite-mailboxes' ); ?></em>
						<?php elseif ( Settings::get( 'self_register' ) || current_user_can( 'edit_users' ) ) : ?>
						...
						<?php else : ?>
							<em><?php esc_html_e( 'No mailbox yet — an administrator can create one for you.', 'mailkite-mailboxes' ); ?></em>
						<?php endif; ?>
					</td>
				</tr>
			<?php else : ?>
				...
				<?php if ( $is_self ) : ?>
					<tr>
						...
						<td>
							<p style="margin-top:0"><?php esc_html_e( 'Add this account to Apple Mail, Thunderbird, or any IMAP client:', 'mailkite-mailboxes' ); ?></p>
							...
							<p class="description"><?php esc_html_e( 'The same password is also an API bearer token for this address — your inbox screen uses it, and so can your own scripts.', 'mailkite-mailboxes' ); ?></p>
							<script>
				...
				<?php endif; ?>
				<tr>
					<th scope="row"><?php esc_html_e( 'Manage', 'mailkite-mailboxes' ); ?></th>
